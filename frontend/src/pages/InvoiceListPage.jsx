           ...
           <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-200">
                  ...
                  <th className="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-widest text-[10px] text-center">Generated By</th>
                ...
                {loading ? (
                  ...
                  filtered.map(inv => (
                    ...
                    >
                      ...
                      <td className="px-6 py-5 text-center">
                        <Badge variant="outline" className="text-[10px] bg-white border-slate-200 text-slate-600 uppercase">
                          {inv.creator?.name || 'Owner'}
                        </Badge>
                      </td>
